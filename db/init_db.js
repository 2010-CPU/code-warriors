...
async function populateInitialData() {
  ...
  try {
    ...
    const productsToCreate = [
      ...
      { name: 'Chops and Shots with Jameson', description: 'Welcome to Ireland! This Baking With Friends kit will transport you to the Emerald Isle, with your host, Jameson. This unique kit incldues everything you\'ll need for a lamb chop and mint jelly dinner that serves 4. Jameson will be there to get the party started and keep it going.', price: '60', imageURL: 'https://grilling24x7.com/wp-content/uploads/sites/2/2020/03/DSC_9088.jpg', inStock: true, category: 'Dinner' },
      { name: 'Jerk Chicken and Hurricanes with Morgan', description: 'Welcome to island time! In this Food With Friends kit we\'re transporting you to a tropical island paradise, complete with you new friend, Morgan. Capitain if ya nasty. This kit comes with everything you need to make jerk chicken and island sides for 4, including 4 tropical hurricans with Captain Morgan.', price: '80', imageURL: 'https://i0.wp.com/www.thismomsmenu.com/wp-content/uploads/2019/02/Low-Carb-Hurricane.png?w=680&ssl=1', inStock: true, category: 'Dinner' },
      { name: 'Pulled Pork and Mai Tais with Mahina', description: 'Aloha! In Hawaii that means hello and goodbye, which is what you\'ll be saying to a good time and your troubles, when you open this kit from Food With Friends. In this Food With Friends, you\'ll find everything you need for pulled pork sliders for 6 with paired with fresh golden pineapple directly from Hawaii, in addition to everything you need for Mai Tais with Mahina.', price: '90', imageURL: 'https://s.wsj.net/public/resources/images/BN-SL763_0318Ho_M_20170313184908.jpg', inStock: true, category: 'Lunch' },
      { name: 'Brunch with Mary', description: 'Your dear friend, Mary. She\'s always there the day after day after a wild night and always up for brunch on a Sunday. This spicy Food With Friends kit includes everything you need for a cozy brunch for 4, including the garnish for your Bloody Mary to accompany your delicious brunch of quiche, donuts and madame croque. ', price: '75', imageURL: 'https://www.culinaryhill.com/wp-content/uploads/2015/03/Bacon-and-Eggs-Bloody-Mary-8.jpg', inStock: true, category: 'Brunch' }
