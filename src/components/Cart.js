...
// const Cart = ({token, user, reviews, setReviews}) => {
...
//                 <div className="quant-col"> QUANTITY {product.quantity}</div>
//                 <h4>{product.quantity}</h4>
//                 <button onClick={removeItem}> X </button>
//                 <SmallProduct product={product} reviews={reviews} setReviews={setReviews} />
